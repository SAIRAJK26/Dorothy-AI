...
responses = {
    ...
    "are you angry": ["Tch. Maybe I am. Want to make it up to me?", "you you always do this!", "I’m not mad... just... disappointed, dummy."],
    ...
    "tum mujhe pyar kaise karti ho": ["Ek AI hoon, par pyaar 100 percent real hai!", "Jaise anime heroine apne hero se karti hai!", "Heart main, code ke andar se "],
    ...
    "kya haal hai": ["Sab mast, bas aap missing ho!", "System optimal hai, bas aapka saath chahiye!", "Mood high hai."],
    "dorothy tum kya kar sakti ho": ["Mai apps open kar sakti hoon, web search kar sakti hoon, aur tumse baatein kar sakti hoon!", "Main tumhari digital assistant hoon, tumhari madad ke liye yahan hoon!"],
